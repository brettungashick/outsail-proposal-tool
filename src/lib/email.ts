    ...
    html: `
      <div style="font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, sans-serif; max-width: 520px; margin: 0 auto; padding: 32px 0;">
        <div style="text-align: center; margin-bottom: 24px;">
          <span style="font-size: 24px; font-weight: 700; color: #1E3A6B;">Out</span><span style="font-size: 24px; font-weight: 700; color: #4277c7;">Sail</span>
        </div>
        <div style="background: #ffffff; border: 1px solid #e2e8f0; border-radius: 0; padding: 32px;">
          ...
          <div style="text-align: center; margin: 24px 0;">
            <a href="${inviteUrl}" style="display: inline-block; background: #4277C7; color: #ffffff; padding: 12px 32px; border-radius: 0; font-size: 14px; font-weight: 600; text-decoration: none;">
              Set Up Your Account
            </a>
          </div>
    ...
    html: `
      <div style="font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, sans-serif; max-width: 520px; margin: 0 auto; padding: 32px 0;">
        ...
        <div style="background: #ffffff; border: 1px solid #e2e8f0; border-radius: 0; padding: 32px;">
          ...
          <div style="text-align: center; margin: 24px 0;">
            <a href="${shareUrl}" style="display: inline-block; background: #4277C7; color: #ffffff; padding: 12px 32px; border-radius: 0; font-size: 14px; font-weight: 600; text-decoration: none;">
              View Comparison
            </a>
          </div>
          <p style="color: #94a3b8; font-size: 12px; line-height: 1.5; margin: 24px 0 0;">
    ...
    html: `
      <div style="font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, sans-serif; max-width: 520px; margin: 0 auto; padding: 32px 0;">
        ...
        <div style="background: #ffffff; border: 1px solid #e2e8f0; border-radius: 0; padding: 32px;">
          ...
          <div style="text-align: center; margin: 24px 0;">
            <a href="${resetUrl}" style="display: inline-block; background: #4277C7; color: #ffffff; padding: 12px 32px; border-radius: 0; font-size: 14px; font-weight: 600; text-decoration: none;">
              Reset Password
            </a>
          </div>
          <p style="color: #94a3b8; font-size: 12px; line-height: 1.5; margin: 24px 0 0;">
