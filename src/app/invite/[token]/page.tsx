      ...
      <div className="min-h-screen flex items-center justify-center bg-sidebar">
        <div className="w-full max-w-md">
          <div className="bg-white rounded-2xl shadow-lg p-8 text-center">
            ...
            <p className="text-sm text-slate-500 mb-6">Your account is ready. Sign in to get started.</p>
            <button
      ...
      <div className="w-full max-w-md">
        <div className="bg-white rounded-2xl shadow-lg p-8">
          <div className="text-center mb-8">
            ...
            {inviteData ? (
              <>
                <h2 className="text-xl font-bold text-slate-900">Welcome, {inviteData.name}!</h2>
                <p className="text-sm text-slate-500 mt-1">
                  Set a password for <span className="font-medium">{inviteData.email}</span>
                </p>
              </>
            ) : (
