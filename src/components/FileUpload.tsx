  ...
  return (
    <form onSubmit={handleSubmit} className="space-y-4">
      ...
      {inputMode === 'file' ? (
        <div
          className={`border-2 border-dashed rounded-lg p-6 text-center cursor-pointer transition ${
            dragActive
              ? 'border-outsail-blue bg-outsail-blue/5'
              : file
        ...
        <div>
          <textarea
            ...
            className="w-full px-3 py-2 border border-slate-300 rounded-lg focus:ring-2 focus:ring-outsail-blue focus:border-outsail-blue outline-none resize-y"
            rows={8}
      ...
      <button
        type="submit"
        disabled={!canSubmit}
        className="w-full bg-outsail-blue-dark text-white py-2 rounded-lg text-sm font-medium hover:bg-outsail-navy transition disabled:opacity-50 disabled:cursor-not-allowed"
      >
