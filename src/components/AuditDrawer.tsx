                  ...
                  return (
                    <div key={idx} className="bg-slate-50 rounded-lg p-3">
                      <div className="flex items-center gap-2 mb-1">
                        <svg className="w-4 h-4 text-outsail-blue-dark" fill="none" viewBox="0 0 24 24" strokeWidth={2} stroke="currentColor">
                      ...
                      {canFetchEvidence && !cached && (
                        <button
                          ...
                          className="text-xs text-outsail-blue-dark hover:text-outsail-navy mt-1"
                        >
                ...
                {cellEvents.map((event, idx) => (
                  <div key={idx} className="text-xs text-slate-600 flex items-start gap-2">
                    <span className={`inline-block w-1.5 h-1.5 rounded-full mt-1.5 flex-shrink-0 ${
                      event.type === 'extraction_set_cell' ? 'bg-outsail-blue' : 'bg-amber-400'
                    }`} />
                    <div>
